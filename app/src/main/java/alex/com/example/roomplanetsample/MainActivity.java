...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlanetViewModel.getAllPlanets().observe(this, new Observer<List<Planet>>() {
            ...
            @Override
            public void onChanged(@Nullable final List<Planet> planets) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_PLANET_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            Planet planet = new Planet(data.getStringExtra(NewPlanetActivity.EXTRA_REPLY));
            mPlanetViewModel.insert(planet);
        } else {
            Toast.makeText(
